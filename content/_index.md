  ...
  - section_id: features
    ...
    grid_items:
      - title: 'Наркіс. Розмова про те: Пізнай себе'
        content: "\tГ. Сковорода назвав цей твір своїм \"першорідним сином\", тобто першим філософським твором, і повідомив у \"Пролозі\", що його написано \"на сьомому десятку століття цього\" — у 70-х роках. "
        actions:
          - label: Get Started
            url: /docs
            style: link
